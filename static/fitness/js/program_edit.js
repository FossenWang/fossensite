...
function formatTrainingToField(){
    ...
    //绑定点击事件
    $(".training .add-sets").click(addTrainingSets);
    $(".training .delete-sets").click(deleteTrainingSets);
    $(".training .add-day").click(addTrainingDay);
    $(".training .delete-day").click(deleteTrainingDay);
}
...
function formatSets(ts){
    ...
    + '&emsp;<button type="button" class="delete-sets btn">×</button></div>')
...
function formatDay(td){
    ...
    + '&emsp;<button type="button" class="delete-day btn">×</button></div>'
